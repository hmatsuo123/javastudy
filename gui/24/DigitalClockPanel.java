...
public class DigitalClockPanel extends JPanel implements Runnable{
	...
	public Color clockFontColor = Color.GREEN;
	public Color clockBackgroundColor = new Color(40, 40, 40);
	...
	public static DigitalClockPanel newInstance(JFrame owner) {
		DigitalClockPanel panel = new DigitalClockPanel(owner);
	...
	public void paintComponent(Graphics g) {
		...
		((DigitalClock)owner).updateWindow(panelSize);
	};
	...
	public class DigitalClockAnimation {
		...
		public void drawTime(Graphics g, Color fontColor, Font font) {
			...
			if (isAnimationOn) {
				...
				g.setColor(fontColor);
				g.setFont(font);
				g.drawString(getNowTime(), defaultTimeX, clockFont.getSize() - panelMarginHeight);
